...
INSERT INTO
  author(author_name,username,password)
VALUES
  ('张宇','rabbiton1989','890924');
...
VALUES
  (1,'2月大兴、房山成北京楼市热点 共成交2819套','2月大兴、房山成北京楼市热点 共成交2819套','凭借新产业的引入、区域配套的提升、轨道交通的建设，北京大兴区、房山区楼市开始快速发展。');
